...
{% include article-image.html src="/assets/gradle/build-scan-summary.png" alt="Build Scan Summary" caption="The Summary tab" %}

Drilling down into the Performance tab, you'll find all sorts of details about your build:

{% include article-image.html src="/assets/gradle/build-scan-performance.png" alt="Build Scan Performance" caption="The Performance overview tab" %}
...
{% include article-image.html src="/assets/gradle/build-scan-network.png" alt="Build Scan Network Activity" caption="Zero is my hero" %}
...
{% include article-image.html src="/assets/gradle/build-scan-script-configuration.png" alt="Build Scan Script Configuration" caption="Example script configuration time" %}
...
{% include article-image.html src="/assets/gradle/build-scan-gc-performance.png" alt="Build Scan GC Performance" caption="4/124 = 3.2%, looks good" %}
...
{% include article-image.html src="/assets/gradle/build-scan-timeline-bad.png" alt="Build Scan Timeline" caption="Ouch" %}
...
{% include article-image.html src="/assets/gradle/build-scan-timeline-good.png" alt="Build Scan Timeline" caption="Balance" %}
...
{% include article-image.html src="/assets/gradle/build-scan-incremental-timeline.png" alt="Build Scan Incremental Timeline" caption="C'mon, we're sooo close!" %}
